...
| architect | ch01 § The Lighthouse Request | ch11 § The Architect's Role; appA § Technical Ownership and Decision Boundaries |
| architectural claim | ch03 § Formulating the Architecture Question and Intended Decision | ch07 § Matching Checks to Claims; appA § Claim Scope |
...
| architecture synthesis | ch11 § Framing the Architecture Problem | ch11 § Integrating Across Layers and Disciplines; appA § Technical Ownership and Decision Boundaries |
| architecture world model | ch05 § Prediction and World Models | ch05 § Combining Methods Without a Fixed Order |
| artifact | ch01 § An Artifact Is Not an Architecture Result | ch04 § Sources of Architecture Data; ch10 § Defining the Evaluation Objects and Workflow Under Test |
| attempt | ch06 § Attempts, Jobs, and Dependencies | ch10 § Total Cost; appA § Execution Provenance and Replay |
| authoritative source | ch04 § From Data to Architecture Knowledge and Current State | ch09 § Transfer Units, Dependencies, and Actions |
| Bayesian optimization | ch05 § Optimization Allocates Scarce Evaluations | ch05 § Selecting a Search Procedure; ch10 § Separating Workflow Effects From Component Contributions |
| benchmark health, contamination, and retirement | ch10 § Benchmark Health and Comparable Results | appA § Environment, State, and Provenance |
| blind spots and known unknowns | ch04 § Blind Spots and Known Unknowns Stay Visible | ch06 § Returned Records and Reproducibility; appA § Claim Support and Reopening Conditions |
| blocking constraint | ch10 § Architecture Result | ch11 § Interpreting Results and Disagreement; ch11 § Making and Limiting a Design Commitment |
| candidate | ch01 § An Artifact Is Not an Architecture Result | ch03 § Exploring Alternatives Within the Declared Space; ch10 § Defining the Evaluation Objects and Workflow Under Test |
...
| confounding | ch07 § Controlling Confounding and Selection | ch10 § Reliability Across Conditions; appA § Variation and Statistical Support |
| cross-layer provenance | ch04 § Cross-Layer Relationships Need Provenance | ch06 § Setup, State, and Lineage; appA § Environment, State, and Provenance |
| data movement | ch01 § An Architecture Result Needs More Than One Score | ch02 § Evaluation and Verification Limit Progress; ch09 § Local Gains Must Survive End-to-End Product Costs |
...
| distribution shift and drift signal | ch07 § Reopening and Requalifying | ch09 § The Target Change Determines What Reopens; ch10 § Reliability Across Conditions |
| domain specialist | ch11 § The Architect's Role | ch07 § Routing the Next Technical Action; appA § Technical Ownership and Decision Boundaries |
| electronic design automation (EDA) | preface § What This Book Teaches | ch01 § AI as Design Automation; ch06 § Tool-Connected Design Environments |
| engineering role | ch05 § Roles and Methods Answer Different Questions | ch01 § AI as Design Automation; appA § Engineering Roles and Method Families |
| environment | ch06 § Tools, Wrappers, Harnesses, and Environments | ch03 § Implementing a Testable Candidate; ch10 § Identifying the System Under Test; appA § Environment, State, and Provenance |
| equivalence and refinement checking | ch07 § Equivalence, Refinement, and Composition | ch09 § Integration and Operating Conditions Still Need Checks; ch10 § Attacking Constraints and Unrewarded Requirements |
| evaluation capacity | ch02 § Design Spaces Grow Faster Than Evaluation Capacity | ch05 § Method Cost and Evaluation Capacity; ch09 § Cheap Checks Help Only Within Validated Coverage |
| evaluation objects | ch10 § Defining the Evaluation Objects and Workflow Under Test | ch10 § Matching Complete Workflows |
| exact replay | ch06 § Returned Records and Reproducibility | ch08 § What the Repository Retains; appA § Execution Provenance and Replay |
| executable software path | ch02 § Software Is Part of the Machine | ch09 § The Executable Software Path; appA § Claim Support and Reopening Conditions |
| execution failure taxonomy | ch06 § Failure Returns and Tool-Output Parsing | ch04 § Retaining Failed and Censored Observations; ch07 § Routing the Next Technical Action; appA § Independent Checks and Failure Records |
...
| matched complete workflows | ch10 § Matching Complete Workflows | ch01 § Two Independent Tests for the Moonshot; ch11 § Closing the Moonshot |
| method family | ch05 § Roles and Methods Answer Different Questions | ch01 § AI as Design Automation; appA § Engineering Roles and Method Families |
| multi-fidelity methods | ch04 § Acquiring Samples Across Cost and Fidelity | ch05 § Optimization Allocates Scarce Evaluations; ch06 § Multi-Tool and Multi-Fidelity Environments |
| negative transfer | ch09 § Transfer Units, Dependencies, and Actions | ch10 § Reliability Across Conditions |
| no added method | ch05 § Roles and Methods Answer Different Questions | ch08 § The Decision and Fixed State |
| observation | ch01 § An Artifact Is Not an Architecture Result | ch04 § Cost and Coverage of a Sample; ch06 § Interfaces and Tool Wrappers; ch07 § Sources of Returned Signals |
| offload granularity | ch09 § Break-Even Bounds for Offload | ch02 § Executable Software Paths |
| optimization | ch01 § AI as Design Automation | ch05 § Optimization Allocates Scarce Evaluations; ch10 § Separating Workflow Effects From Component Contributions |
| optimizer's curse | ch10 § Exposing Proxy Failure | ch07 § Controlling Confounding and Selection |
...
| residual risk | ch11 § Stating Residual Risk | ch07 § Routing the Next Technical Action; appA § Technical Ownership and Decision Boundaries |
| retrieval | ch01 § AI as Design Automation | ch04 § From Data to Architecture Knowledge and Current State; ch05 § Roles and Methods Answer Different Questions; ch10 § Separating Workflow Effects From Component Contributions |
| reversibility | ch11 § Making and Limiting a Design Commitment | ch05 § Method Choice Begins With the Limiting Work; ch09 § Changed Conditions Create Test Obligations |
| RISC-V | ch01 § The Lighthouse Request | preface § What This Book Teaches; ch08 § The Decision and Fixed State; ch11 § Framing the Architecture Problem |
| robustness | ch10 § Varying Architecture-Relevant Conditions | ch07 § Qualifying a Proxy for the Decision; appA § Variation and Statistical Support |
| Roofline model | ch01 § An Artifact Is Not an Architecture Result | ch09 § Break-Even Bounds for Offload |
| SCALE-Sim | ch08 § A Separate Executed Array Study | ch09 § The Target Change Determines What Reopens; ch09 § Cheap Checks Help Only Within Validated Coverage |
| scoped study | ch03 § Six Responsibilities From Intent to Decision | ch08 § Running the Design Loop; appA § The Architecture 2.0 Reviewer's Checklist |
...
| supported, unsupported, and unresolved statuses | ch10 § Reporting What the Evaluation Supports | ch11 § Architecture Result, Program Claim, and Commitment; appA § The Architecture 2.0 Reviewer's Checklist |
| surrogate model | ch01 § An Artifact Is Not an Architecture Result | ch05 § Prediction and World Models; ch07 § Qualifying a Proxy for the Decision |
| synthetic data | ch04 § Acquiring Samples Across Cost and Fidelity | ch10 § Benchmark Health and Comparable Results |
| systolic-array study | ch08 § A Separate Executed Array Study | ch09 § The Target Change Determines What Reopens; ch10 § Reporting What the Evaluation Supports |
| tacit knowledge | ch03 § The AI-Assisted Design Life Cycle | ch11 § Choosing Abstractions, Components, and Constraints |
| technical recommendation | ch11 § Architecture Result, Program Claim, and Commitment | ch01 § An Artifact Is Not an Architecture Result; ch08 § Two Stops and Their Next Actions; appA § Technical Ownership and Decision Boundaries |
| threat model | ch10 § Threat Models and Test Selection | ch01 § An Architecture Result Needs More Than One Score; ch09 § Changed Conditions Create Test Obligations |
...
| XRBench | ch01 § The Lighthouse Request | ch02 § Software Change Can Invalidate Hardware Comparisons; ch03 § Formulating the Architecture Question and Intended Decision |
...
- Appendix A is a reviewer instrument, and Appendix B is a chapter-principle
  digest. Neither appendix owns definitions already established in the main
  text.
