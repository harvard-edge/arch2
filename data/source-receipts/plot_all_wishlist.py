...
plt.title("Ch1: The Productivity Asymmetry")
plt.legend()
...
plt.title("Ch2: The Collapse of Moore's Cost-Scaling")
...
plt.title("Ch3: The Silicon CI Compute Heatmap (Lint vs Sim vs PnR)")
...
plt.title("Ch4: Topological Explosion of Open-Source RTL")
...
plt.title("Ch5: The Agentic Sweet Spot")
...
plt.title("Ch6: Cloud-Native EDA & API Tapeouts")
plt.tight_layout()
...
plt.title("Ch7: RTL Mutation Survival Curve")
...
plt.title("Ch8: RL Convergence vs Baselines")
plt.legend()
...
plt.title("Ch9: The Interconnect Wall")
...
plt.title("Ch10: The Utilization Paradox in LLM-as-a-judge")
...
plt.title("Ch11: The Hardware Attack Surface")
...
try:
    ...
    plt.title("Ch12: The Open Silicon Dependency Matrix")
