...
def main():
    csv_file = (
        REPO_ROOT / "data" / "source-receipts" / "chapter4-data-scarcity-spectrum.csv"
    )
    out_plot = REPO_ROOT / "book" / "images" / "fig-architecture-data-scarcity.svg"
    ...
    # Clean text annotations next to bars
    labels_fmt = [
    ...
    print(f"Pristine Data Scarcity Spectrum plot saved to '{out_plot}'")
