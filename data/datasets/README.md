...
* **Source data:** `chapter1-github-software-hardware-divide.csv`
...
* **Source data:** `chapter2-ai-accelerator-scaling-frontier.csv`
...
* **Source data:** `chapter7-wilson-verification-scissors-gap.csv`
...
* **Source data:** `chapter9-mlperf-software-dividend.csv`
...
* **Datasets:** `mlperf_longitudinal_software_dividend.csv` and `inference_kernel_fragmentation.csv`
* **Scraper & Miner:** `data/scrapers/mine_mlperf_software_dividend.py`
* **Plotting Script:** `plot_mlperf_software_dividend_extended.py`
* **Generated Assets:**
  - `data/datasets/mlperf_longitudinal_software_dividend.{svg,pdf,png}`
  - `data/datasets/inference_kernel_fragmentation.{svg,pdf,png}`
  - `data/datasets/mlperf_software_dividend_extended_master.{svg,pdf,png}`
* **Primary Sources:**
...
* **Datasets:** `tinytapeout_democratization_census.csv` and `shuttle_cost_historical_collapse.csv`
* **Scraper & Aggregator:** `data/scrapers/scrape_tinytapeout_census.py`
* **Plotting Script:** `plot_tinytapeout_democratization.py`
* **Generated Assets:**
  - `data/datasets/fig-tinytapeout-democratization-census.{svg,pdf,png}`
...
* **Source data:** `hardware_security_cve_mitigation_tax.csv` ($N = 20$ major transient execution CVE records and microarchitectural attack classes)
* **Scraper & CVE Miner:** `data/scrapers/mine_hardware_security_cves.py`
* **Plotting Script:** `plot_hardware_cve_performance_tax.py`
* **Generated Assets:**
  - `data/datasets/fig-hardware-cve-mitigation-tax.{svg,pdf,png}`
* **Primary Sources:**
...
* **Source data:** `sec_edgar_semiconductor_rd_economics.csv` ($N = 189$ longitudinal firm-year records across 2000–2026)
* **Scraper & SEC Miner:** `data/scrapers/mine_sec_edgar_semiconductor_rd.py`
* **Plotting Script:** `plot_foundry_wafer_cost_and_rd_wall.py`
* **Generated Assets:**
  - `data/datasets/fig-foundry-wafer-cost-and-rd-wall.{svg,pdf,png}`
