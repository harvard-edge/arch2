...
Dataset Source:
- data/datasets/hardware_security_cve_mitigation_tax.csv

Generated Assets:
- data/datasets/fig-hardware-cve-mitigation-tax.svg
- data/datasets/fig-hardware-cve-mitigation-tax.pdf
- data/datasets/fig-hardware-cve-mitigation-tax.png
"""
...
def load_cve_dataset(csv_path: Path) -> List[Dict[str, Any]]:
    """Loads hardware CVE mitigation tax data from canonical dataset."""
    records = []
...
def build_figure() -> Tuple[plt.Figure, Path, Path, Path]:
    csv_file = (
        REPO_ROOT / "data" / "datasets" / "hardware_security_cve_mitigation_tax.csv"
    )
    ...
    records = load_cve_dataset(csv_file)
    ...
    # Target output paths
    out_svg = REPO_ROOT / "data" / "datasets" / "fig-hardware-cve-mitigation-tax.svg"
    out_pdf = REPO_ROOT / "data" / "datasets" / "fig-hardware-cve-mitigation-tax.pdf"
    out_png = REPO_ROOT / "data" / "datasets" / "fig-hardware-cve-mitigation-tax.png"
