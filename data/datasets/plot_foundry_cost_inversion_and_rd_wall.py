...
def main():
    # Both datasets live in the repository. This script previously read them
    # from a hardcoded absolute path into an agent CLI scratch directory that no
    # longer exists, so the shipped figure could not be regenerated by anyone.
    data_dir = REPO_ROOT / "data" / "datasets"
    node_csv = data_dir / "chapter2-foundry-node-cost-inversion.csv"
    sec_csv = data_dir / "chapter2-sec-edgar-semiconductor-rd.csv"
    ...
    # Save to the chapter's image assets.
