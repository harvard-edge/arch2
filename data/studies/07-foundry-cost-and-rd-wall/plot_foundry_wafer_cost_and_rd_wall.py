...
def main() -> None:
    data_csv = DATA_DIR / "sec_edgar_semiconductor_rd_economics.csv"
    nodes_csv = DATA_DIR / "foundry_node_economics_timeline.csv"

    # Destination output paths
    study7_png = OUTPUT_DIR / "fig-foundry-wafer-cost-and-rd-wall.png"
    study7_pdf = OUTPUT_DIR / "fig-foundry-wafer-cost-and-rd-wall.pdf"
    study7_svg = OUTPUT_DIR / "fig-foundry-wafer-cost-and-rd-wall.svg"
