...
### Plain Text:
> Reddi, V. J., et al. (2026). *Real-World Silicon Errata & Defect Archaeology (2016–2026)*. In **Architecture 2.0: Autonomous AI, Accelerators, and the Future of Silicon Design**. Harvard University & Edge AI Foundation. Available at: `https://github.com/harvard-edge/arch2/tree/dev/data/studies/01-silicon-errata-archaeology`
