...
STUDIES = [
  ...
  url          = {https://github.com/harvard-edge/arch2/tree/dev/data/studies/05-hardware-security-cve-tax}
    ...
    },
    {
        ...
        "title": "Placement Seed Dispersion in OpenROAD (Measured Pilot)",
        "csv_files": ["openroad_gcd_placement_seed_pilot.csv"],
        "plot_scripts": ["plot_openroad_gcd_placement_seed_pilot.py"],
        "figure_bases": ["openroad_gcd_placement_seed_pilot"],
        "scraper": "run_openroad_gcd_placement_seed_pilot.py",
        "summary": "Measures instance area and setup timing slack dispersion across 20 physical placement runs in OpenROAD (pinned container digest) on GCD Nangate45, varying only GPL_RANDOM_SEED.",
        "core_question": "What is the natural quality-of-results (QoR) variance of physical EDA tools across random placement seeds, and are published single-seed AI gains statistically distinguishable from seed noise?",
        "findings": [
            "**Measured Placement Seed Dispersion:** Across twenty runs of GCD on Nangate45 through a digest-pinned OpenROAD container, varying only GPL_RANDOM_SEED: instance area moves 0.84% (median 827.39 um2) and setup worst negative slack (WNS) moves 3.83% (median -156.55 ps).",
            ...
            "**Claim Boundary:** Evaluated on one design (GCD), one PDK (Nangate45), and the placement flow stage. It bounds nondeterminism for this case and must not be cited as a universal magnitude.",
        ],
        "schema": [
            ...
            (
                ...
                "float",
                "Standard cell area after global placement (um2)",
            ),
            (
                "globalplace_setup_wns_ns",
                "float",
                "Setup worst negative slack after global placement (ns)",
            ),
            (
                "globalplace_setup_tns_ns",
                "float",
                "Setup total negative slack after global placement (ns)",
            ),
            (
                "detailedplace_instance_area_um2",
                "float",
                "Standard cell area after detailed placement (um2)",
            ),
            (
                "detailedplace_setup_wns_ns",
                "float",
                "Setup worst negative slack after detailed placement (ns)",
            ),
            (
                "detailedplace_setup_tns_ns",
                "float",
                "Setup total negative slack after detailed placement (ns)",
            ),
            (
                "floorplan_odb_sha256",
                "hex string",
                "SHA-256 hash of input floorplan ODB database",
            ),
            (
                "placement_odb_sha256",
                "hex string",
                "SHA-256 hash of output placed ODB database",
            ),
            (
                "stdout_receipt",
                "filepath",
                "Relative path to retained execution stdout log",
            ),
            (
                "extraction_timestamp",
                "ISO-8601",
                "Timestamp of run execution and log extraction",
            ),
        ],
        "sources": [
            "The OpenROAD Project (OpenROAD-flow-scripts), commit 8359fde.",
            "Nangate Inc., Nangate 45nm Open Cell Library, 2008.",
        ],
        "bibtex": """@misc{arch2_openroad_seed_pilot_2026,
  author       = {Reddi, Vijay Janapa and Contributors},
  ...
  url          = {https://github.com/harvard-edge/arch2/tree/dev/data/studies/06-eda-seed-dispersion}
        ...
        "talking_points": [
            "🎲 **Measured Seed Dispersion:** Twenty runs on identical RTL and floorplan move instance area by 0.84% and setup slack by 3.83%.",
            "🛑 **Single-Sample Limit:** Any single-run optimization claim smaller than this dispersion envelope cannot be distinguished from seed noise.",
            "🔬 **Reproducible Receipts:** Pinned container digest, floorplan ODB hash, and stdout receipts preserved per run.",
        ],
    },
    {
        ...
        "csv_files": [
            "sec_edgar_semiconductor_rd_economics.csv",
            "foundry_node_economics_timeline.csv",
        ],
