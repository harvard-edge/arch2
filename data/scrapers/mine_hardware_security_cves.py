...
DATA_RECEIPTS_DIR = REPO_ROOT / "data" / "datasets"
...
# =====================================================================
# Pipeline Driver & Dataset Generator
# =====================================================================


def generate_dataset_csv(records: List[Dict[str, Any]], output_path: Path) -> Path:
    """Generates the canonical hardware security CVE mitigation tax dataset CSV with metadata header."""
    ...
    header_comments = [
        "# Hardware Security CVEs & Microarchitectural Performance Mitigation Tax Dataset",
...
def main():
    ...
    output_path = generate_dataset_csv(HARDWARE_CVE_RECORDS, OUTPUT_CSV)
