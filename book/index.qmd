...
- **The Computer Architect:** (The primary audience) Hardware implementers who need to know how to integrate AI safely, manage agentic search, and evaluate the design space (@sec-feedback-verification-trust, @sec-running-the-loop).
