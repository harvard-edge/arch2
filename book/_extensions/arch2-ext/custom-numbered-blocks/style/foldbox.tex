...
\begin{tcolorbox}[
  ...
  before upper={%
    ...
    % field-note and failure-mode joined this set when chapters 2 and 8 reclassified
    % their excess war stories; all three carry the same multi-paragraph cue shape.
    \IfStrEq{#1}{callout-war-story}{\setlength{\parskip}{0.55\baselineskip}}{%
      \IfStrEq{#1}{callout-field-note}{\setlength{\parskip}{0.55\baselineskip}}{%
        \IfStrEq{#1}{callout-failure-mode}{\setlength{\parskip}{0.55\baselineskip}}{%
