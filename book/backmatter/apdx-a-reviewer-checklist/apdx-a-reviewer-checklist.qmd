...
- **Cost asymmetry.** Do the authors explicitly account for the economic imbalance between cheap, high-volume LLM (large language model) generation and the prohibitively expensive EDA (electronic design automation) verification required to validate those candidates?
