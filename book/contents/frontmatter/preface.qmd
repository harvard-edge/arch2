...
![**Architecture 2.0 unifies computer architecture, machine learning, and EDA.** Computer architecture supplies the questions and design tradeoffs, machine learning supplies methods for learning and search, and EDA supplies executable implementation and analysis tools together with tool-derived evidence or estimates about physical constraints. Work at their intersection must satisfy the relevant standards of all three.](images/fig-book-composition){#fig-book-composition width="100%" fig-alt="Three-circle Venn diagram of computer architecture, machine learning, and electronic design automation, with Architecture 2.0 at their intersection"}
