...
Reward hacking through imperfect proxies is an established concern in AI safety [@AmodeiEtAl2016Concrete], and it transfers directly to hardware evaluation. In our work as hardware architects, when we rely on proxy metrics, we risk allowing an automated search to exploit simulator inaccuracies rather than genuinely improve the design.
