...
::: {.column-margin}
**Author's Note.** Tools define what a method can explore and what can be observed. When automated methods drive those tools, operational limits must be declared explicitly.
:::
