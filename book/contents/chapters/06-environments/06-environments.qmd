...
**The lineage:** The electrostatic storage tubes were notoriously unreliable, failing every few hours as stored charge leaked and drifted. Core memory roughly doubled the machine's operating speed while raising mean time between failures (MTBF) from hours to weeks, enabling dependable real-time operation.
