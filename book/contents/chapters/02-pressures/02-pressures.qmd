...
#| fig-cap: |
#|   **Silicon release cadences set the exposure window for software adaptation.** Consumer mobile SoCs (Apple M-series) iterate on 7- to 19-month schedules, while enterprise AI accelerators (NVIDIA datacenter GPUs) maintain ~22- to 24-month architectures. Points mark public vendor announcement dates for the M1 through M4 [@Apple2020M1; @Apple2022M2; @Apple2023M3; @Apple2024M4] and for the A100, H100, and B200 [@NVIDIA2020A100; @NVIDIA2022H100; @NVIDIA2024B100]; the Rubin date reflects NVIDIA's January 2026 CES announcement [@NVIDIA2026Rubin]. Hardware decisions remain frozen while compilers, runtimes, and models evolve continuously around them.
#| out-width: "100%"
