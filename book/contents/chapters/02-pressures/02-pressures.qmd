...
![Cerebras Wafer-Scale Engine (WSE) physical size comparison](images/cerebras_wse_scale.jpg)

**Physical scale of the memory bottleneck.** To sustain high operational intensity without being bottlenecked by off-chip HBM transfers, the Cerebras Wafer-Scale Engine shatters the $858\ \text{mm}^2$ photolithography reticle limit (the standard maximum die size, seen on the right in @fig-cerebras-wse-ch02). It delivers a massive 46,225 $\text{mm}^2$ monolithic silicon slab packed with dispersed SRAM arrays.
:::
