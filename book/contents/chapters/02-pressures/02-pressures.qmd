...
These diverging curves illustrate the structural end of automatic frequency scaling [@Sutter2005FreeLunch]. When voltage scaling stalled, power constraints limited the fraction of transistors that could switch simultaneously at peak frequency, creating the *dark silicon* regime [@EsmaeilzadehEtAl2011DarkSilicon]. Because density gains no longer translate into single-thread performance or frequency, architects must extract performance through multicore parallelism, heterogeneous accelerators, and software mapping, dramatically expanding the design space that tools and evaluation harnesses must explore.
