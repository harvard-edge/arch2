...
![**The breakdown of Moore's Law scaling.** Foundry capital expenditure (CapEx) skyrockets exponentially to fund extreme ultraviolet (EUV) lithography, while the cost per billion yielded transistors simultaneously stops falling and begins rising starting at the 28nm node. This inflection was mapped by tracking foundry capital expenditure and wafer pricing against transistor yield densities.](images/plot_ch2.png){#fig-moores-law-breakdown width="80%" fig-alt="Plot showing foundry capital expenditure and cost per billion yielded transistors rising starting at the 28nm node."}
