...
**Design Trade-offs:** In the Bulldozer generation (Zambezi, 2011), AMD grouped two integer cores behind a shared front end and floating-point unit to push clock frequency [@BurgessEtAl2011Bulldozer]. By sharing these structures, the design traded single-thread performance for aggregate throughput.
