...
or SoC block under a 3\ W thermal design power (TDP) target in a 3\ nm-class LP mobile process, and
...
Integrating intellectual property into an SoC introduces strict interface requirements. An accelerator must interface with host infrastructure through standard protocols such as AMBA AXI [@Arm2020AXI]. A candidate that exhibits superior power, performance, and area (PPA) metrics while violating an AXI handshake contract cannot be integrated into production silicon.
