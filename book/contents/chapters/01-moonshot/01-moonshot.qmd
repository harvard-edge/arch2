...
If candidate production speeds past our ability to test, the primary bottleneck shifts directly to verification. Published generation benchmarks report severe attrition at each checking stage [@VerilogEval; @RTLLM; @WangEtAl2025OpenRTLSet], and composing representative stage rates end to end shrinks thousands of generated candidates to a handful that survive parsing, interface compliance, functional simulation, timing closure, and layout checks. We walk that composite attrition stage by stage in @sec-feedback-verification-trust.
