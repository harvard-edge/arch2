...
The scale of that gap is stark. Open-source software gives language models hundreds of billions of tokens to learn from; synthesizable hardware description code is orders of magnitude scarcer, curated architecture corpora and physical layout datasets are smaller still, down to thousands of validated samples [@LozhkovEtAl2024TheStackV2; @WangEtAl2025OpenRTLSet; @PrakashEtAl2025QuArch; @ChaiEtAl2022CircuitNet]. This thousandfold data scarcity gap is why general-purpose language models hallucinate plausible but invalid hardware interfaces, and why AI-native design systems pair specialized domain curation with closed-loop physical verification. We measure the gap tier by tier in @sec-data-representations-world-models.
