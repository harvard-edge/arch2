...
We map this alignment in @fig-moonshot-venn as a three-circle Venn diagram spanning a grand architecture challenge, a substantial shift in design practice, and an enabling advance in AI, data, or tools. Any two of the three, without the third, is an incomplete engineering effort. Tackling a grand challenge without a new method leaves an unsolved problem; proposing a new design practice without an enabling advance remains mere aspiration; and demonstrating an enabling advance without a real architecture challenge yields a vacant capability demonstration.
...
#|   linearly with candidate volume $N$, which climbs exponentially as proposal velocity rises. Early
