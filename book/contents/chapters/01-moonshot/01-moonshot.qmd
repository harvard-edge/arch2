...
The pitfalls above are the ones we already know how to name. What follows are the ones the field has not settled, stated at the width this opening chapter calls for. Each is large enough to organize a research group's agenda or a thesis, and each stays open because of a specific obstacle rather than a shortage of effort.
