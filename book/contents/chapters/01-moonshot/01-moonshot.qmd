...
- **When does an AI-native design system leave a program better off after all of its costs are counted?** Data preparation, failed runs, verification load, and human review all draw on the same budget the speedup was supposed to relieve, and a local gain can move cost rather than remove it. Answering this requires a way to compare complete workflows at matched budgets, which our discipline does not yet have.
