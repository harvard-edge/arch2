"""
DSE Search Efficiency & Convergence Curve Plot Script (Chapter 5)
...
Dataset Receipt: book/contents/chapters/05-methods/data/fig-dse-convergence-pareto.csv
Output Figure:   book/contents/chapters/05-methods/images/fig-dse-convergence-pareto.svg
"""
...
def main():
    ...
    csv_file = chapter_dir / "data" / "fig-dse-convergence-pareto.csv"
    out_plot_ch = chapter_dir / "images" / "fig-dse-convergence-pareto.svg"
    out_plot_global = REPO_ROOT / "book" / "images" / "fig-dse-convergence-pareto.svg"
    ...
    print(
        f"DSE Search Efficiency plot saved to '{out_plot_ch}' and '{out_plot_global}'"
    )
