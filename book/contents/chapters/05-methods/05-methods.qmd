...
: **Direct evaluation provides the defensible starting choice for Lighthouse cache sizing.** A small discrete candidate set without prior matching data justifies direct tool execution over learned surrogates. {#tbl-lighthouse-approach-decision tbl-colwidths="[26,74]"}
