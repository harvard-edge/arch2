...
Sequential placement feels fundamentally different from a static parameter search because every macro location we commit to permanently alters the state for our next choice. The graph-placement loop makes this sequential decision process concrete (@fig-alphachip-placement) [@MirhoseiniEtAl2021GraphPlacement].
