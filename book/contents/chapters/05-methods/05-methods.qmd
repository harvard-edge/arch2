...
The structural screen operates at 2.2% utilization ($32/1{,}440$), simulation runs at 66.7% (8\ arrivals/day against 12/\text{day} capacity), and implementation screening operates at 80% (0.8\ arrivals/day against 1/\text{day} capacity). Physical implementation is the active bottleneck. Expected finalist throughput across an $M$-stage pipeline ($M=3$) is:
