...
Sequential placement feels fundamentally different from a static parameter search because every macro location we commit to permanently alters the state for our next choice. The graph-placement loop of @fig-alphachip-placement runs exactly this sequential decision process [@MirhoseiniEtAl2021GraphPlacement].
