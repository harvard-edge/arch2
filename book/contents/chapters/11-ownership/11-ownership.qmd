...
Architectural ownership does not reside in residual tasks that automation fails to absorb. The essential difficulty of engineering lies in specifying the system rather than merely representing it [@Brooks1986NoSilverBullet]. Technical contribution rests on cross-layer ownership. Architects establish system boundaries across the eight requirement domains (@sec-intent-vs-spec), resolve cross-stack trade-offs, and declare residual risk rather than delegating technical accountability to automated tools.
