...
: **Architecture judgment gives technical work its system meaning.** As architects, we choose the question, abstraction, boundary, and consequence before our commitment authority decides whether the design advances. {#tbl-architect-technical-judgments}
...
: **Program claim status and architecture commitment remain independent.** We cannot substitute a favorable result on one for a favorable result on the other in our architectural methodologies. {#tbl-two-closing-decisions}
...
: **Execution, support, and commitment remain distinctly separate technical decisions in our methodology.** When we separate them, we prevent a successful tool run or a favorable local result from silently authorizing our architecture. {#tbl-lighthouse-action-rights}
