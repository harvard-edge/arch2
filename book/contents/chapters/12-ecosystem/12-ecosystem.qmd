...
Every chapter in this book has closed with questions rather than answers, and this one closes the device as well as the chapter. What we have laid out across these sections is not a complete research agenda, and it was never meant to be. The questions were chosen because we could see the shape of them from where the argument stood, which is a poor guarantee that they are the most important ones. The more useful exercise, once you close the book, is to write down the questions your own design problems raise that none of ours anticipated. The ones below are the subset this chapter can name, and they share the property that no single team can answer them alone.
