...
To guarantee reproducibility, every tool invocation produces an execution record, an immutable structured audit log joining authorized requests, scheduler jobs, input parameters, execution status, returned artifacts, computational costs, and terminal failure causes into a single inspectable object.
