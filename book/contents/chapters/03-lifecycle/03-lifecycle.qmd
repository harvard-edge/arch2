...
- **What structural separation keeps a design loop from approving its own mistakes?** When the same model proposes a change, writes the test, and reads the result, agreement carries much less information than it appears to. Which parts of the loop must be independent, and what independence means when components share training data or heuristics, is unresolved.
