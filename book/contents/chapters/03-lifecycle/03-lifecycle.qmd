...
::: {.callout-failure-mode title="Failure Mode and Trap: Normalization of Deviance in Verification Waivers"}
...
**The Architectural Antidote:** Maintain all waivers in immutable, version-controlled records with named engineering owners and explicit expiration criteria, enforcing zero-waiver signoff policies on safety-critical paths (see @sec-law-normalization-deviance for the waiver lifecycle framework and derated signoff envelopes).
:::
