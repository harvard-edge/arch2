...
These failures appear when the life-cycle boundaries exist on paper and get crossed in practice. A team running real studies commits them, and each one stays invisible until someone tries to reconstruct which stage owned a result and finds that nothing recorded it.
