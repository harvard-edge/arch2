...
We formalize these verification boundaries in @tbl-stage-seams: for each stage it names the input artifacts the stage receives, the deliverables and validation checks it must produce, and the precise return path taken when an output falls short.
