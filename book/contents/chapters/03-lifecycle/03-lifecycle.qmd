...
3. **Build / Implement (B).** Translates abstract candidate parameters into testable representations (transaction-level models (TLMs), synthesizable register-transfer level (RTL), and target software binaries) within clean, sandboxed execution harnesses.
