...
Where the cache study halts before execution, the systolic-array experiment launches directly into operational simulation. This executed study exercises Layer 2 optimization (@fig-ch01-three-layers-ai-integration), exploring legal geometries within a fixed weight-stationary processing-element (PE) container. Because this container operates in isolation, it excludes DRAM bank conflicts, memory bandwidth bottlenecks, compiler lowerings, and full-subsystem thermal envelopes. Interpreting these results requires evaluating them against a frozen research question, ensuring that unexpected simulator returns do not prompt retrospective changes to scoring metrics or candidate filters.
