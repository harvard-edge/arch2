...
Executing a design loop end to end exposes questions that no single stage raises in isolation, particularly around mechanistic hypothesis testing, search budget allocation, and compositional uncertainty across decoupled subsystem loops. What those complete loops can establish remains unsettled.
