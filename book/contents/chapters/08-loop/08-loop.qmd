...
3. **Column Strobe ($t_{\mathrm{CAS}}$):** Issue the column read command to multiplex the requested $64\ \text{B}$ data burst onto the DQ data bus ($14\text{--}18\ \text{ns}$).
