...
A local score tie between evaluation arms does not validate the model's underlying physical explanation: ranking ties and mechanistic predictions address entirely different architectural questions, requiring independent empirical probes to verify.
