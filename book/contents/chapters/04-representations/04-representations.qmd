...
::: {.callout-failure-mode title="Fallacy and Trap: The Streetlight Effect in Hardware AI Benchmarks"}
...
**The Architectural Antidote:** Benchmark suites must evaluate generative tools on multi-clock SoCs, hierarchical interconnects, and physical floorplans (see @sec-law-streetlight-effect for the AST structural depth metrics and multi-clock benchmark qualification rubric).
:::
