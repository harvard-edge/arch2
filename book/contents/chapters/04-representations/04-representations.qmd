...
![**Topological Explosion of Open-Source register-transfer level (RTL).** Plotting Rent's Exponent (Graph Entropy) against Total Gate Count across generations of open-source IP cores reveals the steep scaling of physical wiring complexity as systems grow.](images/plot_ch4.png){#fig-topological-explosion width="100%" fig-alt="Scatter plot showing Total Gate Count vs Rent's Exponent for various open-source hardware designs."}

As open-source hardware scales, capturing physical limits becomes challenging. Visualizing the topological explosion across generations of IP cores demonstrates how wiring complexity outpaces mere gate count (@fig-topological-explosion).
