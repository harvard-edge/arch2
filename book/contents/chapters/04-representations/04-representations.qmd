...
To address these data volume disparities effectively, our representations must account for how different public datasets specialize across distinct abstraction tiers. Four representative public architecture datasets (OpenRTLSet, RTL-Repo, CircuitNet, and QuArch v0.1) differ fundamentally in collection and observation unit, supported task, key missing context, and failed or rejected data status (@tbl-public-architecture-data).
