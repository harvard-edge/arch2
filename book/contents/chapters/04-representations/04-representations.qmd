...
::: {.column-margin}
**Author's Note.** Ludwig Wittgenstein, an influential philosopher of language, tied the boundaries of language to the limits of our world. Our claim for architecture data is equally direct: an automated method can only reason about hardware design states that we explicitly expose to it. If our representation omits a coherence assumption, software contract, or thermal limit, no search loop can deliberately preserve it.
:::
