...
**The Architectural Antidote:** Benchmark suites must evaluate generative tools on multi-clock system-on-chip (SoC) designs, hierarchical interconnects, and physical floorplans (@sec-law-streetlight-effect in @sec-appendix-b-laws-paradoxes).
:::
