...
[^fn-tlm-abstraction-gap-c04]: **Proxy representation drift in simulation abstractions**: TLM 2.0 trades cycle-accurate queue arbitration and flit serialization for orders-of-magnitude simulation speedups. Treating its logs as ground truth introduces representation drift between architectural proxies and physical realization, mirroring the data cascades identified in production ML systems [@SambasivanEtAl2021DataCascades].
...
With our dataset and state representations structured, we can select the learned generation, prediction, and optimization methods that best match our represented design problem. In @sec-methods-generation-prediction-optimization, we evaluate these AI-native co-design methods.
