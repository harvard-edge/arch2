...
These representation principles ensure that data scarcity does not compromise physical fidelity. Preserving failed synthesis runs and negative timing margins prevents learned surrogates from drifting into unroutable floorplans or illusory timing closure. Furthermore, capturing dynamic workload vectors ensures that hardware exploration remains tightly coupled to the software kernels it accelerates.
