...
With our dataset and state representations structured, we can select the generation, prediction, and optimization methods that best match our represented design problem. In @sec-methods-generation-prediction-optimization, we evaluate these AI-native co-design methods.
