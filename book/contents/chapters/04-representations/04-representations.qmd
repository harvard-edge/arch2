...
The consequences of this topological scaling dictate physical viability. As intellectual property (IP) cores transition from embedded microcontrollers (such as PicoRV32) to out-of-order superscalar architectures (such as SonicBOOM), structural graph entropy, characterized by Rent's exponent, explodes. This dense connectivity creates massive routing congestion during physical synthesis, a structural reality that flat lexical representations fundamentally fail to anticipate (@fig-ch04-rent-entropy-congestion).

![**Structural Graph Entropy and Routing Congestion.** As IP cores transition from embedded microcontrollers (PicoRV32) to out-of-order superscalar architectures (SonicBOOM), structural graph entropy (Rent's exponent) explodes, creating massive routing congestion.](images/plot_ch4.png){#fig-ch04-rent-entropy-congestion width="80%" fig-alt="Plot showing structural graph entropy and massive routing congestion increasing from PicoRV32 to SonicBOOM."}
