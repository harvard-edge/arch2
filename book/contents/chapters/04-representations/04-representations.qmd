...
In the prospective Lighthouse cache comparison, the observation unit is one 2\ MiB, 3\ MiB, or 4\ MiB capacity candidate bound to declared design revisions, software images, XR workload snapshots, simulators, and process assumptions. The budget permits one SRAM evaluation per capacity and four cycle-level runs, logging distinct statuses for every attempt.
