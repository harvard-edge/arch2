...
- **Can a design claim be checked by someone who cannot be shown the design?** The most useful architecture data sits behind confidentiality obligations covering netlists, process kits, and calibrated tool traces, which is a principal reason the public corpus is thin. Representations that support independent verification without permitting reconstruction would unlock data that no amount of collection effort otherwise reaches.
