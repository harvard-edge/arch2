...
Representing architectural state across software, microarchitecture, and physical layout requires capturing discrete physical constraints, dynamic workloads, and multi-fidelity observations in machine-usable structures. Key open questions in hardware representation include:
