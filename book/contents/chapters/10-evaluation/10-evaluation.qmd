...
- **Audit benchmark health and zero-point baselines.** Calibrate benchmarks against trivial null agents to prevent baseline inflation, scrub execution containers, and enforce held-out splits to prevent pretraining contamination.
...
- **Evaluate robustness across churn and dispersion.** Characterize candidate quality distributions across physical-design seeds and measure resynthesis latency and locality of invalidation against moving mainline repositories.
:::
