...
explicit, splitting what architects made visible from what that visibility
later enabled (@tbl-historical-loop-transformations). The middle column identifies what architects made
...
percent and named the difference the design productivity gap. The industry never
