...
Evaluation tools form a ladder whose rungs sit orders of magnitude apart in
...
models; emulation buys back about three of those orders at millions of dollars
...
The last rung of the ladder carries a sticker price of its own. A full mask set
...
**Theme 2: Spending a Fixed Evaluation Budget.** A project's limit is how many candidates it can evaluate well enough to decide, not how many it can enumerate, and the rungs of the evaluation ladder sit orders of magnitude apart in throughput, license cost, and schedule.
