...
One auditable acquisition rule is GP-UCB[^fn-ml-gp-ucb-c05]. The logged acquisition rule, not its abstract no-regret bound,[^fn-ml-no-regret-c05] lets a reviewer examine why the optimizer selected a particular point [@SrinivasEtAl2010GPUCB].
