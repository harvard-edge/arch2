...
[^fn-6-reinforcement-learning]: **Reinforcement learning**: a machine learning paradigm where an agent learns to make sequential decisions by receiving rewards or penalties from its environment.
