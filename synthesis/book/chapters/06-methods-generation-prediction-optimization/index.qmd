...
[^fn-6-no-regret-guarantee]: **No-regret guarantee**: a formal promise about a sampling rule under stated assumptions, useful only when the loop records whether those assumptions hold.
