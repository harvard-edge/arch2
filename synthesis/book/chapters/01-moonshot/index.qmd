...
[^fn-1-foundation-model]: **Foundation model**: a large-scale AI model trained on a vast quantity of data that can be adapted to a wide range of downstream tasks. Carried across to hardware, the
