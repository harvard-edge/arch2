...
learning is possible. A Bayesian optimizer[^fn-7-bayesian-optimizer], reinforcement-learning policy,
surrogate model[^fn-7-surrogate-model], critic, or tool-using agent should behave differently when a
