...
Environment design should therefore include red-team checks^[**Red-teaming**: intentionally attacking a system to expose vulnerabilities, flaws, and failure modes before deployment.] for the feedback
