...
[^fn-3-bayesian-optimization]: **Bayesian optimization**: a strategy for optimizing expensive black-box functions when each evaluation is costly [@SnoekLarochelleAdams2012BayesianOptimization].
