...
% Wrap long lines in code listings so they never overflow the trim.
% Quarto's `code-overflow: wrap` does not inject fvextra breaklines in this
% Springer/SNmono setup, so force it here. Applies to every listing at once.
\usepackage{fvextra}
